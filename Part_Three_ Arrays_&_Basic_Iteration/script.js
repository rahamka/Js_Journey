...
// let array_91 = [21, 34, 32, 42, 21];
// let cleaned_91 = [];
// array_91.reduce((prev, curr) => {
//   if (prev !== curr) {
//     return cleaned_91.push(curr);
//   } else {
//     return;
//   }
// });
// console.log(cleaned_91);
...
//   // how i can add here index like this => [`Chunk${index} = ${val}]
...
// note:
// 1. I want to remove the comments from this code
// 2. Problems which i can't solve they should be as like they are or same
// 3. eg.  100.  Write a function that implements a custom shuffle algorithm for an array. it should be same not solve this and other problems which i can't but i will bro?
